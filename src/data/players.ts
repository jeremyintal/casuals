export const PLAYERS: string[] = [
  ...
  'Gerald Wallace', 'Kris Humphries', 'Keith Bogans', 'MarShon Brooks',
  'Kris Joseph', 'Dwight Powell', 'Erik Murphy', 'Malcolm Thomas',
  'John Lucas III', 'Jameer Nelson', 'Brandan Wright',
